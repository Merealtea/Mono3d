...
# yapf: disable
from .pipelines import (Collect3D, DefaultFormatBundle3D,
                                        LoadAnnotations3D,
...
# yapf: enable
from .pipelines import PIPELINE_MODULES
...
def is_loading_function(transform):
    ...
    if isinstance(transform, dict):
        if transform['type'] not in PIPELINE_MODULES:
            return False
        
        obj_cls = PIPELINE_MODULES[transform['type']]
